...
public class Class_Order {
    ...
    public Class_Order(int order_id, int client_id, int provider_id, int sub_service_id, String order_date, String target_date,
                       String order_time, int ammount, int discount, int net_rate, String status, int offer_id, String name,
                       String service_name) {
